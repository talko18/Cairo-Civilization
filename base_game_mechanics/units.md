...
| Modern | Infantry | 70 | Requires Oil |
...
| Industrial | Artillery | 50 | 70 | 3 | First 3-range siege. Requires Oil |
| Modern | Rocket Artillery | 60 | 90 | 3 | |
...
| Military Engineer | Industrial | Build Forts, Airstrips, railroads |
...
- Promoting **ends the unit's turn**
...
Strategic resources are binary in the base game: you either have access to the resource
or you don't. Having at least 1 copy of the resource allows production of all units
