...
| Encampment | Military | Bronze Working | +1 per Government Plaza (standard adjacency only). Cannot be adjacent to City Center |
| Theater Square | Culture | Drama and Poetry | +2 per Wonder, +1 per Entertainment Complex/Water Park, +0.5 per district |
...
| Water Park | Amenities (Coastal) | Radio (Rise & Fall) | Must be on Coast tile. No standard adjacency bonuses |
| Preserve | Nature/Faith | Mysticism (DLC) | Cannot be adjacent to City Center |
| Diplomatic Quarter | Diplomacy | Various (DLC) | One per empire |
...
| Dam | Flood Protection | Buttress (GS) | Must be on Floodplains tile |
| Canal | Water Connection | Steam Power (GS) | Connects water bodies or City Center to water |

### Government Districts (One Per Empire)

| District | Unlock | Notes |
|----------|--------|-------|
| Government Plaza | State Workforce (R&F) | One per empire. +8 Loyalty. Grants Governor Title per building (4 total). Standard adjacency bonus to nearby districts |
...
- **Standard bonus (+1):** Secondary features or Government Plaza adjacency
...
| 3 | Research Lab | +5 Science, +1 Great Scientist point, +1 Citizen slot. Requires Power |
...
| 3 | Broadcast Center | +4 Culture, +1 Great Musician point, 1 Great Music slot. Requires Power |
...
| 3 | Stock Exchange | +7 Gold, +1 Great Merchant point, +1 Citizen slot. Requires Power |
...
| 3 | Power Plant | +4 Production (6-tile area effect), +1 Great Engineer point. Generates Power |
...
| Government Plaza, Diplomatic Quarter | 30 Production |
| Dam, Canal | 81 Production |
...
| Power Plant | +4 Production, Power generation |
| Zoo | +1 Amenity |
| Stadium | +1 Amenity |
...
| Korea | Seowon | Campus | Flat +4 Science, loses adjacency for each adjacent district |
...
| Brazil | Street Carnival / Copacabana | Entertainment Complex / Water Park | Carnival project for extra Great People points |
| Kongo | Mbanza | Neighborhood | Available much earlier; provides +5 Housing, +2 Food, +4 Gold |
| Zulu | Ikanda | Encampment | Allows building Corps/Armies earlier |
